package com.binggoling.javaUtil.对象转Json;
...
import com.binggoling.javaUtil.对象转Json.bean.LikeBean;
import com.binggoling.javaUtil.对象转Json.bean.MyBeanWithPerson;
import com.binggoling.javaUtil.对象转Json.bean.Person;
import com.binggoling.javaUtil.对象转Json.bean.TestBean;
	...
	//字符串json转换成json， 根据情况是用JSONArray或JSONObject
	  ...
	  //复合类型bean转成成json
	    ...
	    public void testBeadToJSON(){
	    	...
	    	likeBean.setFoot("banana");
	    	likeBean.setMovement("baskeball");
	    	bean.setLikeBean(likeBean);
